...
#tmpdir = os.environ.get("JOBFS")
#new_tmpdir = tmpdir + '/data_vishnu/'
#mkdir_p(new_tmpdir)
#output_location = '/fred/oz002/vishnu/neural_network/lowlat_cands/%s/ '%directory + new_tmpdir
#
#print output_location
#cmds = 'cp -r ' + output_location + ' ' + new_tmpdir
#print cmds
...
ldf = dataloader('lowlat_cands_train.txt')
print "Running"
#for p in ldf.pfds:
    #p.extracted_feature = {}
...
cPickle.dump(clfl2, open('/fred/oz002/vishnu/neural_network/htru_s_lowlat_trained.pkl' ,'wb'), protocol=2)
